...
static int ImmediateOutput = 0; /* 1 if immediate error output required */
static int GrammarLine = 0;     /* 1 to print AG line number */
static int ErrorLimit = 0;      /* 1 to abort after too many errors */
